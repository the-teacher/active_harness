# 004 — Request Lifecycle Hooks

## Topic

How to use hooks to execute code at different stages of request execution.

## Why This Is Needed

Hooks let you intervene in the request's workflow: normalize input data, log events, transform results, and handle errors.
...
class HookedRequest < ActiveHarness::Request
  ...
  on :setup do
    puts "[SETUP] Initializing request..."
...
# Use the request
request = HookedRequest.new(input: "  Hello,  how are you?  ")
request.call
