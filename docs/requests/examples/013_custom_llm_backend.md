...
```ruby
class LocalRequest < ActiveHarness::Request
...
# Usage
request = LocalRequest.new(input: "Question")
request.call
...
```ruby
class HybridRequest < ActiveHarness::Request
...
```ruby
class RubyLLMRequest < ActiveHarness::Request
...
# Usage
request = RubyLLMRequest.new(input: "Question")
request.call
puts request.result.output
```
...
```ruby
class StreamingRubyLLMRequest < ActiveHarness::Request
  system_prompt RubyLLMPrompt
...
request = StreamingRubyLLMRequest.new(
...
```ruby
class MonitoredRubyLLMRequest < ActiveHarness::Request
  system_prompt RubyLLMPrompt
